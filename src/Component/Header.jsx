            ...
            <div className="container">
                <div className="head">
                    <div className="row align-items-center">
                        ...
                        {/* ICONS */}
                        <div className="icon-sec col-6 col-lg-3 d-flex align-items-center justify-content-end">
                            <ul className="d-flex m-0 align-items-center">
                                <li className="me-1 d-none d-lg-block">
                                    <NavLink to="/wishlist" className="c-icon"><FaRegHeart size={18} /></NavLink>
                                </li>
                                <li className="mx-1 d-none d-lg-block">
                                    <NavLink to="/login-register" className="c-icon"><FaRegUser size={18} /></NavLink>
                                </li>
                                <li className="ms-1 d-none d-lg-block">
